...
Paste the contents of the video_stream.liq file into that text area. (In newer versions of AzuraCast with the "Import Configuration" button on this page, you can just upload the video_stream.liq file and it will be set in the correct location.)
